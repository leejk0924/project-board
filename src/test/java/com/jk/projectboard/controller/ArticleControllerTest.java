...
import com.jk.projectboard.config.TestSecurityConfig;
...
import com.jk.projectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    public void givenNothing_whenRequestArticlesView_thenReturnsArticlesView() throws Exception {
        // ArgumentMatchers 는 한 개의 파라미터에만 넣을 수 없기에, eq() 사용
    ...
    // userDetailsServiceBeanName 생략 가능
    ...
    @Test
    void givenNothing_whenRequesting_thenRedirectsToLonginPage() throws Exception {
        // Given
        long articleId = 1L;
